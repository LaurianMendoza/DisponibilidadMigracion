...
<main>
    ...
    @php
        $empleadosSinRepetirSize = count($empleadosSinRepetir);
        $i = 0;
    @endphp

    @foreach ($empleadosSinRepetir as $e)
                ...
                <table class="table-nombreEmpleadoincidenciaSeleccion">
                    <thead>
                        <tr class="font-weight-bold">
                            <th style="text-align: center;">{{$e->Numero}}</th>
                            <th style="text-align: left;">{{$e->Nombre}}</th>
                        </tr>
                    </thead>
                </table>
        ...
        <table class="table-incidenciaSeleccion" style="margin-top: 10px;">
            ...
            <tbody>
                ...
                @foreach($lista as $incidencias)
                    @if($e->idempleado == $incidencias->IdEmpleado)
                        <tr>
    ...
    <table class="table-incidenciaSeleccionConteo" style="margin-top: 10px;">
        ...
        <tbody>
            ...
            @foreach($conteos as $conteo)
                @if($e->idempleado == $conteo->IdEmpleado)
                    <tr>
