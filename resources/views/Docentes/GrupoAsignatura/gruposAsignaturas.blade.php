...
@section('location')
    <li class="breadcrumb-item"><b>GRUPOS-ASIGNATURA</b></li>
@endsection
                                ...
                                <table data-ordering="false" id="info" class="table w-100 table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($grupos as $item)
                                            @php
                                                $IdGrupo = base64_encode($item->idgrupo);
                                            @endphp
                                            <tr class="zoomin_smooth_Ssm" style="text-align: center;">
                                                <td style="vertical-align: middle;">{{ $item->clave }}</td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="dropdown " id="btn_opc{{ $item->idgrupo }}">
                                                        <button class="dropdown-toggle btn bg-primary px-2 box text-white" aria-expanded="false" data-tw-toggle="dropdown">
                                                            <span class="w-5 h-5 flex items-center justify-center"><i data-lucide="chevron-down"></i> </span>
                                                        </button>
                                                            ...
                                                            <ul class="dropdown-content">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        ...
                                                                        id="btn_edit{{ $item->idgrupo }}">
                                                                        <i class="fas fa-chalkboard-teacher text-green"></i>
                                                                        <span class="ml-3">EDITAR GRUPO</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div style="display: none;" class="buttons_edit{{ $item->idgrupo }}">
                                                        <button onclick="updateGrupo('{{ $item->idgrupo }}')"
                                                            class="btn btn-primary btn_anim">
                                                            <i class="fas fa-save"></i>
                                                        </button>
                                                        <button onclick="deshabilitarEdicion('{{ $item->idgrupo }}')"
                                                            class="btn btn-danger btn_anim">
