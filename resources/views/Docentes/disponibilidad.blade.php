            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="disponibilidad" data-day="{{$day}}" data-hour="{{$hour}}">
                        <form action="{{ route('disponibilidad.update') }}" method="POST">
                            @csrf
                            <input type="hidden" name="day" value="{{$day}}">
                            <input type="hidden" name="hour" value="{{$hour}}">
                            <button type="submit" @if($enviado) disabled @endif class="btn btn-default btn-disponibilidad" id="btn-{{$day}}-{{$hour}}" style="{{ $disponibilidad[$day][$hour] ? 'background-color: green;' : '' }}">Disponible</button>
                        </form>
                    </td>
